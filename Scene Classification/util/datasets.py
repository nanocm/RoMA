...
class MillionAIDDataset(data.Dataset):
    def __init__(self, root, transform=None):
        ...
        print("Creating dataset MillionAID", self.files[0:10])
...
def build_dataset(is_train, args):
    ...
    if args.dataset == 'millionaid':
        ...
        # args.nb_classes = 51
        dataset = MillionAIDDataset(data_path, transform=transform)
    elif args.dataset == 'nwpu':
        print('Loading NWPU-RESISC45 dataset!')
        data_path = '/root/NWPU-RESISC45'
        args.nb_classes = 45
        ...
        data_path = '/root/ucm'
        args.nb_classes = 21
        dataset = UCMDataset(data_path, train=is_train, transform=transform, split=args.split, tag=args.tag)
    else:
